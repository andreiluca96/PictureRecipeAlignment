...
public class SWP implements SearchableCipher {
    ...
    public byte[] decrypt(byte[] cipherBytes, long recordID) throws Exception {
        ...
        // decrypt(blockCipherBytesLeft) = Wn-m
